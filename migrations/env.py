...
target_metadata = SQLModel.metadata    # model- metadata- alembic compare model vs db- generate migration to apply changes
...
# everytime we change anything or update in models.py, we run migration (alembic revsion --autogenerate -m "added/updated/done")
# then apply change (alembic upgrade head)